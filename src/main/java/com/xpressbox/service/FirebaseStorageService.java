...
public class FirebaseStorageService {
    ...
    final String BucketName = "xpressbox-330e3.firebasestorage.app";

    
    //Esta es la ruta básica de este proyecto XpressBox
    final String rutaSuperiorStorage = "XpressBox";

    //Ubicación donde se encuentra el archivo de configuración Json
    final String rutaJsonFile = "firebase";

    //El nombre del archivo Json
    final String archivoJsonFile = "xpressbox-330e3-firebase-adminsdk-fbsvc-ff48908f01"+".json";
